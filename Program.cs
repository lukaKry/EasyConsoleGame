  ...
  class Program
  {
	static void Main(string[] args)
    {
      ...
      while (true)
      {
        ...
        // End game if a boundry is reached
        if (characterRow == 0 || characterRow == rows || characterCol == 0 || characterCol == cols)
        {
          Console.Clear();
          Console.SetCursorPosition(0, 0);
          Console.CursorVisible = true;
          Console.WriteLine("You touched the boundry. You loose!!");
